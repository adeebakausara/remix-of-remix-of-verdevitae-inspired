...
export const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-24 lg:py-32 section-cream" ref={ref}>
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-medium text-secondary-foreground leading-tight mb-6">
              ...
              <span className="italic text-accent">not fragile.</span>
            </h2>
            <div className="space-y-4 text-secondary-foreground/80 leading-relaxed">
              ...
              <p>
                <strong className="text-secondary-foreground">The issue is not weakness. The issue is load.</strong>
              </p>
              <p>
          ...
          <motion.div
            ...
            className="bg-background rounded-2xl p-8 lg:p-10 card-shadow"
          >
        ...
        >
          <h3 className="font-serif text-2xl md:text-3xl text-secondary-foreground mb-8">
          ...
          <p className="mt-8 text-accent font-medium italic">
